...
# MANNSI: Check that env variables are actually set. I had to manually modify them. I also had to run 'sudo apt-get install cuda-9-0' to get rid of an error when importing tensorflow
